...
getSystemSettingsPath, getSystemDefaultsPath, saveSettings, getDefaultsFromSchema, loadEnvironment, migrateDeprecatedSettings, SettingScope, LoadedSettings, sanitizeEnvVar, } from './settings.js';
    ...
    describe('loadEnvironment', () => {
        function setup({ isFolderTrustEnabled = true, isWorkspaceTrustedValue = true, }) {
            ...
            mockFsExistsSync.mockImplementation((p) => {
                ...
                return [path.resolve(USER_SETTINGS_PATH), geminiEnvPath].includes(normalizedP);
            });
            const userSettingsContent = {
                ui: {
                    theme: 'dark',
