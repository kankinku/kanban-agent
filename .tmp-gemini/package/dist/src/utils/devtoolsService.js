 ...
 */
export async function setupInitialActivityLogger(config) {
...
export function startDevToolsServer(config) {
    if (connectedUrl)
        return Promise.resolve(connectedUrl);
 ...
 */
export async function toggleDevToolsPanel(config, isOpen, toggle, setOpen) {
    if (isOpen) {
        toggle();
        return;
    }
...
//# sourceMappingURL=devtoolsService.js.map