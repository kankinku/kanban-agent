...
import { SlashCommandStatus, makeFakeConfig, coreEvents, CoreEvent, } from '@google/gemini-cli-core';
...
describe('useSlashCommandProcessor', () => {
    ...
    describe('Conflict Notifications', () => {
        it('should display a warning when a command conflict occurs', async () => {
            ...
            expect(mockAddItem).toHaveBeenCalledWith(expect.objectContaining({
                type: MessageType.INFO,
                text: expect.stringContaining("- Command '/deploy' from extension 'firebase' was renamed"),
            }), expect.any(Number));
        });
