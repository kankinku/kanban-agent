...
export const DialogManager = ({ addItem, terminalWidth, }) => {
    ...
    const { constrainHeight, terminalHeight, staticExtraHeight, terminalWidth: uiTerminalWidth, shouldShowRetentionWarning, sessionsToDeleteCount, } = uiState;
    ...
    if (shouldShowRetentionWarning && sessionsToDeleteCount !== undefined) {
        return (_jsx(SessionRetentionWarningDialog, { onKeep120Days: handleKeep120Days, onKeep30Days: handleKeep30Days, sessionsToDeleteCount: sessionsToDeleteCount ?? 0 }));
    }
