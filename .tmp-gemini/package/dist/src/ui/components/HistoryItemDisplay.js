...
export const HistoryItemDisplay = ({ item, availableTerminalHeight, terminalWidth, isPending, commands, activeShellPtyId, embeddedShellFocused, availableTerminalHeightGemini, }) => {
