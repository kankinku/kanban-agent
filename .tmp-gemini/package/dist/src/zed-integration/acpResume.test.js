...
import { AuthType, CoreToolCallStatus, } from '@google/gemini-cli-core';
...
describe('GeminiAgent Session Resume', () => {
    ...
    it('should load a session, resume chat, and stream all message types', async () => {
        ...
        SessionSelector.mockImplementation(() => ({
        ...
        convertSessionToHistoryFormats.mockReturnValue({
        ...
        expect(mockConfig.getGeminiClient().resumeChat).toHaveBeenCalledWith(mockClientHistory, expect.objectContaining({
...
//# sourceMappingURL=acpResume.test.js.map