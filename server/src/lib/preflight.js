 ...
 * runPreflight() 호출 시:
 *  1. Node.js 버전 체크
 *  2. CLI 도구(gh / gcloud / codex) 체크 → 미설치 시 자동 설치 → PATH 갱신 후 재탐색(최대 3회)
...
const CLI_TOOLS = [
  {
    name: 'gh',
    label: 'GitHub CLI',
    severity: 'warn',   // 미설치해도 서버 기동 허용, 해당 프로바이더만 비활성
    install: {
      win32:  'winget install --id GitHub.cli -e --silent --accept-package-agreements --accept-source-agreements',
